...
export async function CreateTicket(
    ...
    usersToAdd.forEach((user) => void ticketChannel.send(`<@${user}>`).then((message) => message.delete()));
    ...
    const embed = CreateEmbed(`**Ticket __${channelName}__ created in <#${ticketChannel.id}>**`, { color: "success" });
