...
export const ArtifactDescriptions: { [key in ArtifactItems]: string } = {
    ...
    mask_shard: "[Very rare] A small, intricately carved fragment of some ancient material. It's hard to tell what it was originally a part of, but you have a feeling that if you could find enough of these shards, you might be able to create something truly remarkable.",
...
export default {
    ...
    Explore: {
         ...
         */
        ArtifactChances: [["void_crystal", 200], ["mask_shard", 35], ["crystal_heart", 35], ["pale_ore", 1]] as ItemsWithWeight<ArtifactItems>,
    }
};